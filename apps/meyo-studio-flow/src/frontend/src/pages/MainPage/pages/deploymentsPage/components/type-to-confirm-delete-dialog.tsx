          ...
          <DialogTitle>
            <div className="flex items-center">
              <AlertTriangle
                ...
                strokeWidth={1.5}
              />
              <span className="pl-2">{t("deployments.delete.title")}</span>
            </div>
          </DialogTitle>
        </DialogHeader>
        <div className="flex flex-col gap-3 pb-3 text-sm">
          <p>
            {t("deployments.delete.descriptionPrefix")}{" "}
            <strong>{deploymentName}</strong>{" "}
            {t("deployments.delete.descriptionSuffix")}
          </p>
          <label htmlFor="confirm-delete-input" className="text-sm">
            {t("deployments.delete.typeToConfirm")}{" "}
