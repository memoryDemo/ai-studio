        ...
        <div className="flex shrink-0 items-center pb-4">
          <div className="xl:container">
            <div className="relative w-full xl:w-5/12">
              ...
              />
              <Input
                placeholder={t("knowledge.chunks.searchPlaceholder")}
                value={searchQuery}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {t("knowledge.chunks.showingRange", {
                            start: startIndex + 1,
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5 px-2 text-sm">
                          <span>{t("knowledge.chunks.page")}</span>
                          <input
                            type="number"
                            min={1}
                            max={totalPages}
