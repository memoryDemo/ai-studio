...
from meyo.util import get_gpu_memory
from meyo.util.parameter_utils import _genenv_ignoring_key_case
...
def huggingface_loader(
    ...
    from meyo.model.llm.compression import compress_module
    ...
    if device == "cpu":
        ...
        if version < (4, 35, 0):
            from meyo.model.llm.monkey_patch import (
