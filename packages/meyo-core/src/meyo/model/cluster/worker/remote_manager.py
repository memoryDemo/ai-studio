...
from meyo.model.cluster.worker.manager import LocalWorkerManager, WorkerRunData, logger
from meyo.model.cluster.worker.remote_worker import RemoteModelWorker
...
class RemoteWorkerManager(LocalWorkerManager):
    ...
    def _build_single_worker_instance(self, model_name: str, instance: ModelInstance):
        ...
        wr = WorkerRunData(
            ...
            semaphore=asyncio.Semaphore(100),  # 代码说明。
        )
        return wr
