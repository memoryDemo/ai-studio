...
from meyo.core.interface.storage import ResourceIdentifier, StorageItemAdapter
from meyo.storage.metadata import Model
...
class ModelInstanceEntity(Model):
    ...
    __tablename__ = "meyo_cluster_registry_instance"
    __table_args__ = (
        UniqueConstraint(
            "model_name",
            "host",
