"""模型服务参数定义，负责描述大语言模型、向量生成、重排、工作进程和接口服务配置。"""
...
from meyo.util.configure.manager import RegisterParameters
...
class ModelWorkerParameters(BaseServerParameters):
    ...
    worker_class: Optional[str] = field(
        default=None,
        metadata={
            "help": _("Model worker class, meyo.model.cluster.DefaultModelWorker")
        },
    )
