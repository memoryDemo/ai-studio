...
class OpenTelemetrySpanStorage(SpanStorage):
    ...
    def append_span(self, span: Span):
        ...
        if span_id in self.spans:
            ...
            otel_span.set_attribute("meyo_trace_id", span.trace_id)
            otel_span.set_attribute("meyo_span_id", span.span_id)

            if span.parent_span_id:
                otel_span.set_attribute("meyo_parent_span_id", span.parent_span_id)
    ...
    def _create_parent_context(self, span: Span):
        ...
        span_context = SpanContext(
            ...
            is_remote=True,
            trace_flags=trace.TraceFlags(0x01),  # 默认配置说明。
        )
